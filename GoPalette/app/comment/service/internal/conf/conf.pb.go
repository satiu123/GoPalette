...
func (*Registry) Descriptor() ([]byte, []int) {
	return file_app_comment_service_internal_conf_conf_proto_rawDescGZIP(), []int{4}
}
...
func (*Registry_Etcd) Descriptor() ([]byte, []int) {
	return file_app_comment_service_internal_conf_conf_proto_rawDescGZIP(), []int{4, 0}
}
...
const file_app_comment_service_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	",app/comment/service/internal/conf/conf.proto\x12\x12kratos.api.comment\x1a\x1egoogle/protobuf/duration.proto\"\xd5\x01\n" +
	"\tBootstrap\x122\n" +
	...
	"\x04auth\x18\x03 \x01(\v2\x18.kratos.api.comment.AuthR\x04auth\x128\n" +
	"\bregistry\x18\x04 \x01(\v2\x1c.kratos.api.comment.RegistryR\bregistry\"\xc8\x02\n" +
	"\x06Server\x123\n" +
	...
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeoutBFZDgithub.com/satiu123/GoPalette/app/comment/service/internal/conf;confb\x06proto3"
...
var file_app_comment_service_internal_conf_conf_proto_goTypes = []any{
	...
	(*Registry)(nil),            // 4: kratos.api.comment.Registry
	(*Server_HTTP)(nil),         // 5: kratos.api.comment.Server.HTTP
...
var file_app_comment_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 3: kratos.api.comment.Bootstrap.registry:type_name -> kratos.api.comment.Registry
	5,  // 4: kratos.api.comment.Server.http:type_name -> kratos.api.comment.Server.HTTP
