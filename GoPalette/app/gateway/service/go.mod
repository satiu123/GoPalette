module github.com/satiu123/GoPalette/app/gateway/service
...
require (
	...
	github.com/go-kratos/kratos/contrib/registry/consul/v2 v2.0.0-20220318065833-e66a2905ab70 // indirect
